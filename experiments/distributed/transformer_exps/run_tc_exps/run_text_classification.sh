...
do
  ...
  do
    ...
    python -m fedavg_main_tc \
      ...
      --poison_trigger_pos "fixed 0 15" --manual_seed $seed \
      --exp_name "alpha=${alpha}-pratio=0.01-num_trigger=3-pos=fixed_0_15-seed=${seed}" --reprocess_input_data
    ...
    python -m fedavg_main_tc \
      ...
      --server_lr $S_LR --server_momentum 0.9 \
      --epochs 1 \
      --output_dir "/tmp/fedavg_${DATA_NAME}_output/" --manual_seed $seed \
